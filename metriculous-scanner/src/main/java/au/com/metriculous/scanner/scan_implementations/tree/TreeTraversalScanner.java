...
import au.com.metriculous.scanner.api.tree.ConflictResult;
...
public class TreeTraversalScanner implements Scanner, ConflictResult {
    ...
    private final TreeTraversalFileAnalyzer treeTraversalFileAnalyzer;
    private boolean complete = false;

    public TreeTraversalScanner(Repository repository, TreeTraversalFileAnalyzer fileAnalyzer) { //, ExecutorService executorService) {
        this.repository = repository;
        this.treeTraversalFileAnalyzer = fileAnalyzer;
    }
